...
import Img1 from "../assets/products/DR-3900-l3.png";
import Img3 from "../assets/products/MG24_port.png";
import pdfname24 from '../assets/pdf/DR-IES2000-Carrier-Ethernet Series.pdf'
import pdfname25 from '../assets/pdf/DR3900_organized.pdf'
import pdfname26 from '../assets/pdf/DR3900_organized.pdf'
...
const Enterprisel3nonpoe = ({ handleOrderPopup }) => {
  return (
    <div>
      <div className="relative w-full overflow-hidden min-h-[500px] sm:min-h-[500px] bg-no-repeat bg-cover text-white bg-[url('https://www.antaira.com.tw/img/insight-og/Article-OG_PoE.jpg')] flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200 ">
        <div className="container pb-8 sm:pb-0">
          <h1 className="text-5xl font-bold sm:text-4xl lg:text-4xl">Enterprise L3 Non Poe</h1>
        </div>
      </div>
...
export default Enterprisel3nonpoe;
