...
const Contact = () => {
  ...
  const validationSchema = yup.object().shape({
    ...
    textarea: yup.string().required("Please Enter Message"),
  });
            ...
            <div class="grid md:grid-cols-2">
              <div class="h-full pr-6">
                <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                  ...
                  networking platforms for service providers to unlock the
                  potential of open networking and release the new service
                  experience across mobile and multi-cloud landscapes.
                </p>
                <ul class="mb-6 md:mb-0">
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      ...
                      <p class="text-gray-600 dark:text-slate-400">
                        E-29, Third Floor, E Block, Sector 63, Noida, Uttar
                        Pradesh 201301
                      </p>
                    </div>
                  </li>
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      ...
                      <p class="text-gray-600 dark:text-slate-400">
                        Mobile: +91-8178803636
                      </p>
                      <p class="text-gray-600 dark:text-slate-400">
                        Mail: sales@devray.in
                      </p>
                    </div>
                  </li>
                  <li class="flex">
