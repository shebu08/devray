...
import pdfname11 from '../assets/pdf/DR4010P8C2F.pdf'
import pdfname12 from '../assets/pdf/DR4T8016G-SFP.pdf'
import pdfname13 from '../assets/pdf/DR4T8024G-SFP.pdf'
...
const Industrialgrade_l3NonPoe  = ({ handleOrderPopup }) => {
  return (
    <div>
      <div className="relative w-full overflow-hidden min-h-[500px] sm:min-h-[500px] bg-no-repeat bg-cover text-white bg-[url('https://www.antaira.com.tw/img/insight-og/Article-OG_PoE.jpg')] flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200 ">
        <div className="container pb-8 sm:pb-0">
          <h1 className="text-5xl font-bold sm:text-4xl lg:text-4xl">Industrial Grade  L3 Non PoE</h1>
        </div>
      </div>
...
export default Industrialgrade_l3NonPoe ;
