import Img2 from "../assets/products/poe1.png";
import { usePageTitle } from 'react-simple-page-title';
import Img1 from "../assets/products/mg_16_port.png";
import Img4 from "../assets/products/non-poe-4T24G.png";
import Img3 from "../assets/products/MG24_port.png";
import pdfname17 from '../assets/pdf/DR5010P8C2F.pdf'
import pdfname18 from '../assets/pdf/DR5018GSM.pdf'
import pdfname19 from '../assets/pdf/DR5018GSM.pdf';
import pdfname20 from '../assets/pdf/DR7052XGSM.pdf'
...
const Enterprisel2nonpoe = ({ handleOrderPopup }) => {
  usePageTitle("Enterprise L2 Non Poe");
    ...
    <div>
      <div className="relative w-full overflow-hidden min-h-[500px] sm:min-h-[500px] bg-no-repeat bg-cover text-white bg-[url('https://www.antaira.com.tw/img/insight-og/Article-OG_PoE.jpg')] flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200 ">
        <div className="container pb-8 sm:pb-0">
          <h1 className="text-5xl font-bold sm:text-4xl lg:text-4xl">Enterprise L2 Non Poe</h1>
        </div>
      </div>
...
export default Enterprisel2nonpoe;
